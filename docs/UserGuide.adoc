...
[NOTE]
Select command is different from clicking the patient card in the window. It enables you to select the patients who were soft deleted
...
.Select a patient
image::select_patient.PNG[width="600"]
...
[NOTE]
Select command is different from clicking the appointment card in the window. It enables you to select the appointment in the past.
...
image::select_appointment.PNG[width="600"]
