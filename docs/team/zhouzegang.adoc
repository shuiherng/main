...
This project portfolio documents `Zhou Zegang`’s contributions
to project `PatientBook`. [https://github.com/CS2103-AY1819S1-T12-2/main[PatientBook]]
...
* *Code contributed*: [https://nus-cs2103-ay1819s1.github.io/cs2103-dashboard/#=undefined&search=zzg229&sort=displayName&since=2018-09-12&until=2018-11-12&timeframe=day&reverse=false&repoSort=true[Code From Dashboard]]
...
*** Resolved CSV file reading in Jar for drug utility function (Pull requests [https://github.com/CS2103-AY1819S1-T12-2/main/pull/184[#184]])
** Project management:
*** Set up Travis for team project on Travis CI
*** Added labels in issue tracker on GitHub (Label list [https://github.com/CS2103-AY1819S1-T12-2/main/labels[Label]])
*** Assigned issues to teammates on GitHub (Issues [https://github.com/CS2103-AY1819S1-T12-2/main/issues/65[#65]])
** Bug fix: Resolved bugs that other teams assigned (Issues [https://github.com/CS2103-AY1819S1-T12-2/main/issues/126[#126]] [https://github.com/CS2103-AY1819S1-T12-2/main/issues/129[#129]])
** Documentation:
Update the AboutUs Page (Pull requests [https://github.com/CS2103-AY1819S1-T12-2/main/pull/1[#1]] [https://github.com/CS2103-AY1819S1-T12-2/main/pull/172[#172]])
** Community:
*** reviewed PRs (with non-trivial review comments): (Pull requests [https://github.com/CS2103-AY1819S1-T12-2/main/pull/52[#52]]
 [https://github.com/CS2103-AY1819S1-T12-2/main/pull/177[#177]])
*** Reported bugs and suggestions for other teams (Pull requests [https://github.com/CS2103-AY1819S1-T16-3/main/issues/132[#132]] [https://github.com/CS2103-AY1819S1-T16-3/main/issues/136[#136]]
 [https://github.com/CS2103-AY1819S1-T16-3/main/issues/139[#139]] [https://github.com/CS2103-AY1819S1-T16-3/main/issues/142[#142]]
 [https://github.com/CS2103-AY1819S1-T16-3/main/issues/145[#145]] [https://github.com/CS2103-AY1819S1-T16-3/main/issues/150[#150]])
...
Now it will call the `static` method `writeDataToCsvFile(Disease disease, Set<Symptom> symptoms)` which returns
a `Hashmap` of type `HashMap<Disease, Set<Symptom>>` and assigns it to `this.matcher` to update the `private` attribute.

.Add Disease Code Snippet
[source,java]
----
    /**
