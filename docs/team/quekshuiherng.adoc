...
** *What it does:* Implements an entirely new infrastructure (including command and storage level) code upon which my other project members can implement their appointment scheduling features.
