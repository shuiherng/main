...
.. Test case: `list patient` +
   Expected: Displays the list of patients which have not been deleted.
.. Test case: `list patient all` +
   Expected: Lists all patients, including deleted ones.

. Listing appointments

.. Test case: `list appointment` +
   Expected: Displays the list of appointments which take place from now.
.. Test case: `list appointment all` +
   Expected: List all appointments, including those that took place in the past.
