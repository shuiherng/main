...
public class XmlAdaptedPerson {
     ...
     */
    public XmlAdaptedPerson(String personId, String name, String phone, String email, String address, String exists, List<XmlAdaptedTag> tagged) {
    ...
    public XmlAdaptedPerson(Person source) {
        ...
        exists = source.getExists() ? "true" : "false";
    ...
    public Person toModelType() throws IllegalValueException {
        ...
        if (exists == null) {
            throw new IllegalValueException(String.format(MISSING_FIELD_MESSAGE_FORMAT, "exists"));
        }
        if (!(exists.equals("true") || exists.equals("false"))) {
            throw new IllegalValueException("Existence must either be true or false");
        }
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equals(personId, otherPerson.personId)
                && Objects.equals(name, otherPerson.name)
                && Objects.equals(phone, otherPerson.phone)
                && Objects.equals(email, otherPerson.email)
                && Objects.equals(address, otherPerson.address)
                && exists == otherPerson.exists
