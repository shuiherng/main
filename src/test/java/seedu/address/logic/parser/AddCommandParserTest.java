...
public class AddCommandParserTest {
    ...
    public void parse_validInput_success() {
        // whitespace preamble
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + CMDTYPE_PATIENT + NAME_DESC_BOB,
                new AddCommand(CMDTYPE_PATIENT, NAME_DESC_BOB.trim()));
    ...
    public void parse_invalidInput_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_WHITESPACE + " invalid", expectedMessage);
