...
public class EditCommandTest {
    ...
    public void execute_allFieldsSpecifiedUnfilteredList_success() {
        ...
        AddressBookModel expectedAddressBookModel = new AddressBookModelManager(new AddressBook(addressBookModel.getAddressBook()), new UserPrefs());
    ...
    public void execute_duplicatePersonFilteredList_failure() {
        ...
        Person personInList = addressBookModel.getAddressBook().getAllPersonList().get(INDEX_SECOND_PERSON.getZeroBased());
        EditCommand editCommand = new EditCommand(INDEX_FIRST_PERSON,
    ...
    public void execute_invalidPersonIndexUnfilteredList_failure() {
        ...
        assertCommandFailure(editCommand, addressBookModel, commandHistory, Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);
    }
