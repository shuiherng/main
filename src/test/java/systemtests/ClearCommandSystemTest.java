...
public class ClearCommandSystemTest extends AddressBookSystemTest {
    ...
    public void clear() {
        ...
        assertCommandSuccess(command, expectedResultMessage, new AddressBookModelManager());
        assertSelectedCardUnchanged();
     ...
     * box displays {@code ClearCommand#MESSAGE_SUCCESS} and the addressBookModel related components equal to an empty addressBookModel.
    ...
    private void assertCommandSuccess(String command) {
        assertCommandSuccess(command, ClearCommand.MESSAGE_SUCCESS, new AddressBookModelManager());
    }

    /**
     * Performs the same verification as {@code assertCommandSuccess(String)} except that the result box displays
     * {@code expectedResultMessage} and the addressBookModel related components equal to {@code expectedAddressBookModel}.
     ...
     * box displays {@code expectedResultMessage} and the addressBookModel related components equal to the current addressBookModel.
     * These verifications are done by
     * {@code AddressBookSystemTest#assertApplicationDisplaysExpected(String, String, AddressBookModel)}.<br>
